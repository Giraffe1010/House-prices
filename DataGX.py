# -*- coding: utf-8 -*-
"""
Created on Thu Jun 14 14:40:27 2018
...
print(os.listdir("E:/Project/House price prediction/input"))
data = pd.read_csv('E:/Project/House price prediction/input/train_2.csv')
